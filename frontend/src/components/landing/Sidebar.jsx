    ...
    <Box sx={{ display: 'flex' }}>
      ...
      <AppBar position="fixed" open={open}>
        <Toolbar>
          ...
          <Logo img src={logo} alt="Medtrack logo" />
         <Typography variant="h6">Medtrack</Typography>
        </LogoContainer>
        </Toolbar>
      </AppBar>
      <Drawer variant="permanent" open={open}>
        ...
        <List>
          {[ 
            // { text: 'Medtrack', icon: <Logo/> },
            { text: 'Home', icon: <HomeIcon/>, path: "/" },
            { text: 'Pharmacy', icon: <PharmacyIcon/>, path: "/pharmacy" },
            { text: 'Laboratory', icon: <LaboratoryIcon/>, path: "/laboratory"}
          ].map((item, index) => (
